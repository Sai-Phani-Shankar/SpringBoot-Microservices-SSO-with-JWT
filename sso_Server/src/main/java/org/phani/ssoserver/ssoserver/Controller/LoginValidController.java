...
public class LoginValidController {
    ...
    public ResponseBody ValidateLogin(@RequestBody UserDetail userDetail, HttpServletRequest request){
        ...
        if(!StringUtils.isEmpty(userDetails) && isTokenValid) {
            responseBody.setUserAndTokenValid(true);
        }
        else{
            responseBody.setUserAndTokenValid(false);
        }
